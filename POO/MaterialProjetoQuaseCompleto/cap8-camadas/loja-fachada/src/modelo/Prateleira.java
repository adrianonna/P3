...
public class Prateleira {
	...
	public void adicionar(Produto p){
		produtos.add(p);
		p.setPrateleira(this); //está definindo esta prateleira para ser a pratelerira do produto passado por parâmetro
	}
	...
	public Produto localizar(String nome){ //função do tipo Produto pq retorna p que é do tipo Produto
