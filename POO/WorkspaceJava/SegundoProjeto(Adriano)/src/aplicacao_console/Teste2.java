...
public class Teste2 {
	...
	public static void parte1 () {		
		...
		try {
			...
			Produto cola = Fachada.cadastrarProduto("cola", 20);
			System.out.println("cadastrou produto="+cola.getDecricao());	
			...
			System.out.println("Preço combo2= "+combo1.getPreco());
			...
			System.out.println("Preço combo2= "+combo2.getPreco());
			...
			System.out.println("\nArrecadacao diaria "+ Fachada.calcularArrecadacao(LocalDate.now().getDayOfMonth()));
