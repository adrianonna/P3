...
--criação da view para consulta dos pedidos dos clientes
...
--dando privilégio para o usuário1 consultar a view
grant insert on ClienteCPF to usuario1;


--inserção de dados da view(tbm insere na tabela cliente)
insert into ClienteCPF values (default, 'Fabricio', '83987809422', '', 'F', '25478955894')
...
--função para mostrar todos os pedidos ou pratos daquelo cliente
...
tpro.Qtde_proteina - qtde_ingrediente
where 
